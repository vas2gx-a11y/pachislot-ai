    ...
    },
    {
        ...
        "items": [
            ...
            },
            {
                ...
                "label": "機種情報（解析まとめ）",
                "icon": "📖",
                "description": "天井・ゾーン・設定差・設定示唆などの解析情報を出典付きで確認します。判別スペックへの取り込みもここから。",
            ...
            {
                "endpoint": "judge.machines",
                "label": "判別スペック管理",
                "icon": "🧪",
                "description": "設定判別に使う設定別確率を機種ごとに登録します。ここの数値がそのまま判定結果になります。",
                # 一覧から個別の登録・編集ページへ入るので、その配下も選択状態として扱う
                "match": "/judge/machines",
            },
        ],
    },
    {
